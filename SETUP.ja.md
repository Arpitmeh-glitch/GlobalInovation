...
- **GitHub Issues:** [Issue を作成](https://github.com/Arpitmeh-glitch/GlobalInovation/issues)（バグ報告や要望）
...
楽しい履歴書づくりを！Resume Matcher が役立ったら、[リポジトリに Star](https://github.com/Arpitmeh-glitch/GlobalInovation) と [Discord 参加](https://dsc.gg/resume-matcher) をぜひ。
