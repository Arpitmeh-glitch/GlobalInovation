...
> **Canonical source for agent behavior rules in CareerPilot.**

## What This Repo Is

CareerPilot is an AI-powered application that helps users tailor resumes to job descriptions. It consists of:
