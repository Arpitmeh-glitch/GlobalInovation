    ...
    <div ref={setNodeRef} style={style}>
      ...
      >
        <div className="flex items-start gap-2">
          ...
          {application.review_url && (
            <Link
              href={application.review_url}
              onClick={(event) => event.stopPropagation()}
              className="shrink-0 border border-black bg-blue-700 px-2 py-1 font-mono text-[9px] uppercase tracking-wider text-white"
            >
              Review
            </Link>
          )}
