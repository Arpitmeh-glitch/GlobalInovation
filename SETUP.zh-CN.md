...
- **GitHub Issues：** [提交 Issue](https://github.com/Arpitmeh-glitch/GlobalInovation/issues) 反馈 bug 或提出需求
...
祝你简历制作顺利！如果 Resume Matcher 对你有帮助，欢迎 [给仓库点个 Star](https://github.com/Arpitmeh-glitch/GlobalInovation)，以及 [加入我们的 Discord](https://dsc.gg/resume-matcher)。
